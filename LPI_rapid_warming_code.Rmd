...
CR10s<-brick(here::here("climate_data","cru_ts3.23.2011.2014.tmp.dat.nc"))
```
...
#write.csv(LPIclim, "Global_Mean_Temp.csv")

```


```{r, cache=TRUE}
LPIclim <- read.csv("Global_Mean_Temp.csv")
