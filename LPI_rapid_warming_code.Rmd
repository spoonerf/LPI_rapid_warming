...
df2 <- dfd %>% 
  filter(!is.na(Estimate) & r_sq >= 0.4999999  & time >= 5 & System!="Marine" & Specific_location == 1 & !is.na(both_change)& !is.na(Log_Body_Mass_g) & Protected_status != "Unknown" & Protected_status != "Both" & Class=="Mammalia" ) %>% 
